...
export const THEIPIRAI_SUNDAY_CONFIG = {
  dayTotalMinutes: 780,
...
// Complete 10 Jamas for Theipirai Sunday encoded faithfully from user table
export const THEIPIRAI_SUNDAY_JAMAS: Jama[] = [
    ...
    columns: {
      vulture: {
        ...
        subPeriods: [
          ...
          { birdId: 'cock', star: 5, activity: 'Sleep', startTime: '4:52 AM', durationMinutes: 17, endTime: '5:09 AM', startMinutesFromMidnight: 1732, endMinutesFromMidnight: 1749 },
          { birdId: 'crow', star: 4, activity: 'Walk', startTime: '5:09 AM', durationMinutes: 39, endTime: '5:48 AM', startMinutesFromMidnight: 1749, endMinutesFromMidnight: 1788 },
          { birdId: 'owl', star: 2, activity: 'Die', startTime: '5:48 AM', durationMinutes: 22, endTime: '6:10 AM', startMinutesFromMidnight: 1788, endMinutesFromMidnight: 1810 },
        ],
      },
      owl: {
        birdId: 'owl',
