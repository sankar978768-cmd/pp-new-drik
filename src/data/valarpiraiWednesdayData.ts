...
export const VALARPIRAI_WEDNESDAY_CONFIG = {
  dayTotalMinutes: 780,
  ...
  nightDyingBird: 'Peacock', // Sunset to Sunrise Cock ruling
};

// Complete 10 Jamas for Valarpirai Wednesday encoded faithfully from the uploaded spreadsheet
export const VALARPIRAI_WEDNESDAY_JAMAS: Jama[] = [
  // --- JAMA 1 (6:00 AM - 8:37 AM) --- 157 mins
  ...
  // --- JAMA 2 (8:37 AM - 11:14 AM) --- 157 mins
  ...
  // --- JAMA 3 (11:14 AM - 1:51 PM) --- 157 mins
    ...
    columns: {
      ...
      owl: {
        ...
        subPeriods: [
          ...
          { birdId: 'cock', star: 2, activity: 'Die', startTime: '12:26 PM', durationMinutes: 13, endTime: '12:39 PM', startMinutesFromMidnight: 746, endMinutesFromMidnight: 759 },
  ...
  // --- JAMA 4 (1:51 PM - 4:28 PM) --- 157 mins
    ...
    columns: {
      ...
      peacock: {
        ...
        subPeriods: [
          ...
          { birdId: 'crow', star: 2, activity: 'Die', startTime: '3:42 PM', durationMinutes: 13, endTime: '3:55 PM', startMinutesFromMidnight: 942, endMinutesFromMidnight: 955 },
  ...
  // --- JAMA 5 (4:28 PM - 7:05 PM) --- 157 mins
    ...
    columns: {
      ...
      crow: {
        ...
        subPeriods: [
          ...
          { birdId: 'vulture', star: 1, activity: 'Sleep', startTime: '6:32 PM', durationMinutes: 20, endTime: '6:52 PM', startMinutesFromMidnight: 1112, endMinutesFromMidnight: 1132 },
      ...
      cock: {
        ...
        subPeriods: [
          ...
          { birdId: 'vulture', star: 5, activity: 'Sleep', startTime: '5:59 PM', durationMinutes: 20, endTime: '6:19 PM', startMinutesFromMidnight: 1079, endMinutesFromMidnight: 1099 },
  ...
  // --- JAMA 6 (7:00 PM - 9:13 PM) --- 133 mins
  ...
  // --- JAMA 7 (9:13 PM - 11:26 PM) --- 133 mins
  ...
  // --- JAMA 8 (11:26 PM - 1:39 AM) --- 133 mins
  ...
  // --- JAMA 9 (1:39 AM - 3:52 AM) --- 133 mins
  ...
  // --- JAMA 10 (3:52 AM - 6:05 AM) --- 133 mins
