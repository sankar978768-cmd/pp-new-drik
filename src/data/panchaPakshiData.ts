import { BirdId, BirdInfo, Jama, ActivityType, ActivityDetail } from '../types';

export const ALL_BIRD_IDS: BirdId[] = ['vulture', 'owl', 'crow', 'cock', 'peacock'];

export const BIRDS: Record<BirdId, BirdInfo> = {
  vulture: {
    id: 'vulture',
    name: 'Vulture',
    tamilName: 'கழுகு (Kazhugu)',
    element: 'Earth (பிருத்வி / நிலம்)',
    direction: 'South',
    rulingPlanet: 'Jupiter (குரு)',
    description: 'Day Ruling Bird. Represents high vision, endurance, and decisive authority during sunrise to sunset.',
    color: '#eab308', // Amber / Gold
    accentColor: 'text-amber-400 border-amber-500/40 bg-amber-500/10',
    dayRelation: 'Ruling Bird',
    nightRelation: 'Enemy',
  },
  owl: {
    id: 'owl',
    name: 'Owl',
    tamilName: 'ஆந்தை (Aanthai)',
    element: 'Water (அப்பு / நீர்)',
    direction: 'West',
    rulingPlanet: 'Moon (சந்திரன்)',
    description: 'Day Dying Bird, highly potent in nocturnal cycles. Represents deep intuition and nocturnal wisdom.',
    color: '#38bdf8', // Sky Blue
    accentColor: 'text-sky-400 border-sky-500/40 bg-sky-500/10',
    dayRelation: 'Dying Bird',
    nightRelation: 'Friend',
  },
  crow: {
    id: 'crow',
    name: 'Crow',
    tamilName: 'காகம் (Kaagam)',
    element: 'Fire (தேயு / நெருப்பு)',
    direction: 'North',
    rulingPlanet: 'Saturn (சனி)',
    description: 'Night Ruling Bird. Represents vigilance, endurance, survival intelligence, and nocturnal supremacy.',
    color: '#a855f7', // Purple
    accentColor: 'text-purple-400 border-purple-500/40 bg-purple-500/10',
    dayRelation: 'Enemy',
    nightRelation: 'Ruling Bird',
  },
  cock: {
    id: 'cock',
    name: 'Cock',
    tamilName: 'சேவல் (Seval)',
    element: 'Air (வாயு / காற்று)',
    direction: 'East',
    rulingPlanet: 'Mars (செவ்வாய்)',
    description: 'The Roaring Herald of dawn. Represents courage, awakening, sharp instinct, and rapid movement.',
    color: '#f97316', // Orange
  ...
  peacock: {
    id: 'peacock',
    name: 'Peacock',
    tamilName: 'மயில் (Mayil)',
    element: 'Ether / Space (ஆகாயம்)',
    direction: 'Center',
    rulingPlanet: 'Venus / Mercury (சுக்கிரன்)',
    description: 'The Royal Bird of beauty and poise. Represents royalty, grace, high vibration, and expansion.',
...
export const ACTIVITY_DETAILS: Record<ActivityType, ActivityDetail> = {
  Rule: {
    activity: 'Rule',
    tamilName: 'அரசு (Arasu)',
    weight: 100,
    status: 'Supreme',
    color: 'emerald',
    bgLight: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40',
    description: 'Supreme King state. Maximum vitality and influence.',
    recommendation: 'Best time for vital decisions, signing contracts, launching projects, meetings, purchases.',
  },
  Eat: {
    activity: 'Eat',
    tamilName: 'ஊண் (Oon)',
    ...
    description: 'Nourishment and replenishment. High positive energy.',
    recommendation: 'Highly favorable for study, travel, social discussions, medical treatments, and agreements.',
  },
  Walk: {
    activity: 'Walk',
    tamilName: 'நடை (Nadai)',
    ...
    description: 'Ordinary motion and neutral energy.',
    recommendation: 'Good for daily routine chores, travel, short tasks; avoid major life milestones.',
  },
  Sleep: {
    activity: 'Sleep',
    tamilName: 'துயில் (Thuyil)',
    weight: 25,
    status: 'Inauspicious',
    color: 'indigo',
    bgLight: 'bg-indigo-500/20 text-indigo-300 border-indigo-500/40',
    description: 'Dormant and passive phase. Low energy.',
    recommendation: 'Unsuitable for starting new actions or signing deals. Best for meditation, rest, and routine work.',
  },
  Die: {
    activity: 'Die',
    tamilName: 'சாவு (Saavu)',
    weight: 5,
    status: 'Critical',
    color: 'rose',
    bgLight: 'bg-rose-500/20 text-rose-300 border-rose-500/40',
    description: 'Vulnerable and drained state. Minimum energy.',
    recommendation: 'Strictly avoid important beginnings, arguments, monetary risk, or critical ventures.',
  },
};
...
// All 10 Jamas faithfully encoded from the provided spreadsheet data
export const JAMAS_DATA: Jama[] = [
  ...
  // --- JAMA 8 (10:48 PM - 1:12 AM) ---
  {
    ...
    endMinutesFromMidnight: 1512, // 1:12 AM next day
    columns: {
      vulture: {
        birdId: 'vulture',
        mainActivity: 'Sleep',
